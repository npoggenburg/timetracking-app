...
export const CategorySelector = forwardRef<CategorySelectorRef, CategorySelectorProps>(
    ({ onCategorySelect, selectedCategory, onCategoriesLoaded, theme = 'orange' }, ref) => {
        ...
        if (isLoading) {
            return (
                <div className='space-y-2'>
                    <Label className=''>Select Activity Type</Label>
                ...
                {selectedCategory && (
                    <div
                        className={`mt-4 rounded-md border p-3 ${
                            theme === 'orange' ? 'border-orange-200 bg-orange-50/50' : 'border-blue-200 bg-blue-50/50'
                        }`}
                    >
